...
public class Travels {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.name("first_name")).sendKeys("Boopathi");
		...
		mail.sendKeys("boopathi13456@gmail.com");
		...
		File destination = new File("C:\\Users\\boopa\\eclipse-workspace\\Dropdown\\src\\main\\java\\Phptravel.png");   
